...

{
  ...
  assert(publicSkill.includes("## Public Workflow") && publicSkill.includes("Recommended next operation") && developmentSkill.includes("Before planning, inspect relevant Product Context") && developmentSkill.includes("Skills, MCPs, plugins") && developmentSkill.includes("Recommended next operation"), "public and development skills are not semantically aligned");
