...
function hasExplicitReviewBoundary(content, command) { return ["stop before Work Review", `Recommended next operation: ${command} review WORK-###`, `Do not invoke or simulate \`${command} review\``, "Apply the same stop boundary after approved REWORK remediation execution"].every((marker) => content.includes(marker)); }
