...
function hasTaskPlanningContract(content) { return ["Objective:", "Implementation approach:", "Expected touchpoints:", "Acceptance criteria:", "Targeted validation:", "not ready for approval", "remediation Tasks"].every((marker) => content.includes(marker)); }
