...
- `.agents/skills/nerv/SKILL.md` is the managed public Nerv skill. `.agents/skills/nerv-development/SKILL.md` is internal guidance for developing this repository.
